---
title: 选择合适的协作模式 - CODING 帮助中心
pageTitle: 选择合适的协作模式
pagePrevTitle: 产品概述
pagePrev: collaboration/intro.html
pageNextTitle: Scrum 敏捷项目管理
pageNext: collaboration/pattern/scrum/intro.html
alias: 
-   agile-development/introduce.html
-   collaboration/init.html
-   collaboration/pattern-choice.html
---

CODING 支持 Scrum 敏捷项目管理以及传统项目管理，那么研发团队应该如何根据自身需求及管理偏好，选择**基于传统项目管理模式下的「经典项目管理」**，或是**基于 Scrum 的「Scrum 敏捷项目管理」**？本文将从理念差异、常见的研发模型、适用场景、实践应用等角度来提供选型参考。
...
![](https://help-assets.codehub.cn/enterprise/20201231104854.png)
...
![](https://help-assets.codehub.cn/enterprise/20201231104946.png)
...
![](https://help-assets.codehub.cn/enterprise/20211201151509.png)
...
![](https://help-assets.codehub.cn/enterprise/20201231105032.png)
...
![](https://help-assets.codehub.cn/enterprise/20211201151110.png)
...
前往进入[经典项目管理模式详解](pattern/classic/intro.html)，您的团队可以在此模式下实践多种协作方式。
...
前往进入 [Scrum 敏捷项目管理模式详解](pattern/scrum/intro.html)，帮助您和您的团队快速入门敏捷研发，并通过标准化的流程和完整的信息统计成为企业实践敏捷研发的好工具。

![](https://help-assets.codehub.cn/enterprise/20191220170653.jpeg)
