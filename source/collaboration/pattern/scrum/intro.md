...
pageTitle: 模式介绍
pagePrevTitle: 选择合适的协作模式
pagePrev: collaboration/pattern-choice.html
pageNextTitle: 管理 Backlog
pageNext: collaboration/pattern/scrum/backlog.html
alias: 
-   collaboration/pattern/scrum.html
-   collaboration/pattern/scrum-go.html
---
...
![](https://help-assets.codehub.cn/enterprise/20201225144351.png)

### [关于 Scrum 敏捷项目管理模式](#management)
...
> 扩展阅读——[《深度解读最新版 Scrum 指南》](https://mp.weixin.qq.com/s/At5NXNnTfZH91beK73lN3A)
...
在 CODING Scrum 敏捷项目管理模式下，工作流（迭代、史诗、用户故事、需求、缺陷、任务、子工作项）之间的层级关系可以大体概括为下图：

![](https://help-assets.codehub.cn/enterprise/20210831161514.png)

#### [迭代](#iterations)

迭代是敏捷研发的横轴，意为时间冲刺（Sprint），指团队完成一定数量工作所需的短暂、固定的周期。迭代的生命周期按先后顺序依次为未开始、进行中和已完成三个阶段。在迭代式开发方法中，整个开发工作被组织为一系列短小的、固定长度（如 2 周）的小项目，被称为一系列的迭代。

![](https://help-assets.codehub.cn/enterprise/20201215163355.png)

#### [史诗](#epic)

史诗是敏捷研发的纵轴。它可以将大型工作拆解为细致入微的事项，通常一个史诗要经历多次迭代才能完成。敏捷史诗的范围是灵活的，基于客户反馈和团队开发节奏灵活调整其下需求和任务。可以将史诗分解为粒度较小的需求和任务，并将它们安排到迭代中去完成。

![](https://help-assets.codehub.cn/enterprise/20201215163246.png)
...
![](https://help-assets.codehub.cn/enterprise/20210629214140.png)
...
![](https://help-assets.codehub.cn/enterprise/20201225150631.png)
...
![](https://help-assets.codehub.cn/enterprise/20210630142119.png)
...
关于测试管理的详细内容，可查阅[《测试管理》](https://help.coding.net/docs/test-management/start.html)。
...
![](https://help-assets.codehub.cn/enterprise/20210629215814.png)
